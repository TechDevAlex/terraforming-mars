...
import {OumuamuaTypeObjectSurvey as MartianMystery} from '../../../src/server/cards/pathfinders/OumuamuaTypeObjectSurvey';
...
describe('MartianMystery', function() {
  let card: MartianMystery;
