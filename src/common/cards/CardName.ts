export enum CardName {
  ...
  HERBOLOGY_FIELD_STATION = 'Herbology Station',
  ...
  DEVILS_SNARE_CULTIVATION = 'Devil\'s Snares',
  ...
  THE_GREAT_FLOO = 'The Great Floo',
  DRAGONS = 'Dragons',
  CENTAUR_ASTROLOGERS = 'Centaur Astrologers',
  GRINGOTTS_ENFORCERS = 'Gringotts Enforcers',
  UNICORN_SANCTUARY = 'Unicorn Sanctuary',
  IMPERIUS_COMPETITION = 'Imperius the Competition',
  DARK_RITUALS = 'Dark Rituals',
  TROLL_WORKERS = 'Troll Workers',
  SELF_STIRRING_CAULDRONS = 'Self-stirring Cauldrons',
  STOCK_MARKET_DIVINATION = 'Stock Market Divination',
  COMPUTERIZED_ARITHMANCY = 'Computerized Arithmancy',
  INCORPORATE_MUGGLE_RESEARCH = 'Incorporate Muggle Research',
  TRANSFIGURE_ANTIMATTER = 'Transfigure Antimatter',
  OBLIVIATE = 'Obliviate',
  CONFOUND_MUGGLE_OFFICIALS = 'Confound Muggle Officials',
  BUBBLE_HEAD_CHARMS = 'Bubble-head Charms',
  TRANSFIGURATION = 'Transfiguration',
  GOBLIN_FORGED_MINING_EQUIPMENT = 'Goblin-forged Mining Equipment',
  PHILOSOPHERS_STONE = 'Philosopher\'s Stone',
  ACCIO_COMET = 'Accio Comet',
  DOLORES_UMBRIDGE_TAKES_OVER = 'Dolores Umbridge Takes Over',
