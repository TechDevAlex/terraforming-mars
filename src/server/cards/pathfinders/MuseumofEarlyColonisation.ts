...
export class MuseumofEarlyColonisation extends Card implements IProjectCard {
  constructor() {
    super({
      ...
      behavior: {
        production: {energy: -1, steel: 1, titanium: 1, plants: 1, megacredits: 2},
        tr: 1,
      },
      ...
      metadata: {
        ...
        renderData: CardRenderer.builder((b) => {
          b.production(((pb) => pb.minus().energy(1).nbsp.steel(1).titanium(1).plants(1).megacredits(2)));
          b.br.tr(1);
        }),
        description: 'Requires 1 ocean, 1 city and one greenery on Mars. ' +
         'Decrease your energy production 1 step. Raise your steel, titanium, plant and megacredits production 2 steps. ' +
         'Gain 1 TR.',
      },
    });
  }
