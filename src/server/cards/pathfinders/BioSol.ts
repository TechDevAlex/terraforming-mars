...
export class BioSol extends ActiveCorporationCard {
  constructor() {
    super({
      ...
      firstAction: {
        text: 'Draw 4 cards with a microbe tag',
        drawCard: {count: 4, tag: Tag.MICROBE},
      },
      ...
      metadata: {
        cardNumber: 'PfC14',
        description: 'You start with 42 M€. As your first action, draw 4 cards with a microbe tag.',
        renderData: CardRenderer.builder((b) => {
          b.megacredits(42).cards(4, {secondaryTag: Tag.MICROBE}).br;
