    ...
    super({
      ...
      metadata: {
        ...
        renderData: CardRenderer.builder((b) => {
          b.action('Spend 3 M€ to add an asteroid resource to this card [TITANIUM MAY BE USED].', (eb) => {
            eb.megacredits(3).super((b) => b.titanium(1)).startAction.resource(CardResource.ASTEROID);
          }).br;
