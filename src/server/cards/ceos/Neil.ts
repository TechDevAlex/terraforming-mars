...
export class Neil extends CeoCard {
  constructor() {
    super({
      ...
      metadata: {
        ...
        description: 'Gain 1 M€ when any player plays a Moon tag. Once per game, increase your M€ production by double the value of the LOWEST Moon rate +1 but gets u nothing if all are at 0 u doofus.',
      },
    });
  }
  ...
  public action(player: IPlayer): PlayerInput | undefined {
    ...
    MoonExpansion.ifMoon(game, (moonData) => {
      ...
      if (lowestRate > 0) {
        player.production.add(Resource.MEGACREDITS, (lowestRate*2)+1, {log: true});
      }
    });
