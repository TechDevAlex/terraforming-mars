  ...
  constructor() {
    super({
      ...
      metadata: {
        ...
        description: 'Once per game, add 2 floaters to each of your cards that collect floaters, then add 4 floaters to ANY card. Gain 1 M€ for every floater added this way.',
      },
    });
  }
