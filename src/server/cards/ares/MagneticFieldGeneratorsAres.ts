  ...
  constructor() {
    super(
      ...
      {bonus: [SpaceBonus.PLANT, SpaceBonus.MICROBE]},
      {
        ...
        description: 'Decrease your energy production 3 steps and increase your plant production 2 steps. Raise your TR 3 steps. Place this tile. It provides adjacency bonus of 1 plant and 1 microbe.',
      });
  }
}
