...
export class WasteProcessor extends Card implements IActionCard, IProjectCard {
  constructor() {
    super({
      type: CardType.ACTIVE, name: CardName.WASTE_PROCESSOR, tags: [Tag.SCIENCE], cost: 12,
