...
export class MysteryCard428 extends Card implements IActionCard, IProjectCard {
  constructor() {
    super({
      type: CardType.ACTIVE, name: CardName.MYSTERY_CARD_428, tags: [Tag.BUILDING], cost: 15,
      victoryPoints: 2,
