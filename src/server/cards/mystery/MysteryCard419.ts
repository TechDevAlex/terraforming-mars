...
export class MysteryCard419 extends Card implements IActionCard, IProjectCard {
  constructor() {
    super({
      type: CardType.ACTIVE, name: CardName.MYSTERY_CARD_419, tags: [Tag.SPACE, Tag.EARTH], cost: 10,
