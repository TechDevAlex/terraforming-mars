...
export class MysteryCard485 extends Card implements IActionCard, IProjectCard {
  constructor() {
    super({
      type: CardType.ACTIVE, name: CardName.MYSTERY_CARD_485, tags: [Tag.SCIENCE, Tag.BUILDING], cost: 15,
