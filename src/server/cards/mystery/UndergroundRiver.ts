...
export class UndergroundRiver extends Card implements IProjectCard {
  constructor() {
    super({
      type: CardType.AUTOMATED, name: CardName.UNDERGROUND_RIVER, tags: [Tag.CITY], cost: 10,
      behavior: {production: {titanium: 1, megacredits: 2, energy: 1}},
      metadata: {cardNumber: 'MY141', renderData: CardRenderer.builder((b) => {b.text('Adjust production.');}),
