...
export class MysteryCard373 extends Card implements IActionCard, IProjectCard {
  constructor() {
    super({
      type: CardType.ACTIVE, name: CardName.MYSTERY_CARD_373, tags: [Tag.SPACE, Tag.MARS], cost: 17,
