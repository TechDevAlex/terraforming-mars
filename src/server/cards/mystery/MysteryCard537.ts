...
export class MysteryCard537 extends Card implements IProjectCard {
  constructor() {
    super({
      type: CardType.AUTOMATED, name: CardName.MYSTERY_CARD_537, tags: [], cost: 18,
      behavior: {production: {heat: 1, titanium: 1}},
      metadata: {cardNumber: 'MY537', renderData: CardRenderer.builder((b) => {b.text('Adjust production.');}),
