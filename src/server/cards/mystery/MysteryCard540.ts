...
export class MysteryCard540 extends Card implements IActionCard, IProjectCard {
  constructor() {
    super({
      type: CardType.ACTIVE, name: CardName.MYSTERY_CARD_540, tags: [Tag.CITY, Tag.ANIMAL], cost: 15,
